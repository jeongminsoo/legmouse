...
SELECT ROWNUM, ENAME FROM EMP WHERE DEPTNO = 20 ORDER BY ENAME DESC;
...
SELECT ROWNUM, NUM, SUBJECT, WRITER FROM (SELECT NUM, SUBJECT, WRITER FROM BOARD ORDER BY NUM DESC);

SELECT ROWNUM, RN, NUM, SUBJECT, WRITER FROM (SELECT ROWNUM RN, NUM, SUBJECT, WRITER FROM (SELECT NUM, SUBJECT, WRITER FROM BOARD ORDER BY NUM DESC))
