...
<head>
	...
	<script>
		function deleteBoard(bid) {
			var answer = confirm("정말 " + bid + "번 글을 삭제하시겠습니까?");
			if (answer == true) {
				location.href='${conPath }/mvcboard/delete.do?bid=${param.bid }&pageNum=${param.pageNum }';
			} else {
				return false;
			}
		}
	...
	<table>
		...
		<tr>
			<td colspan="2">
				...
				<button onclick="deleteBoard(${param.bid})">삭제</button>
				<button onclick="location.href='${conPath }/mvcboard/reply.do?bid=${param.bid }&pageNum=${param.pageNum }'">답글작성</button>
