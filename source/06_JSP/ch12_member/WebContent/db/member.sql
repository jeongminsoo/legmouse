...
INSERT INTO FRIEND (NO, NAME, PHONE) VALUES (FRIEND_SEQ.NEXTVAL, '신길동', '010-9999-8888'); 

DELETE FROM FRIEND WHERE NAME = '신길동';

SELECT * FROM FRIEND WHERE NAME = '홍길동';
SELECT * FROM FRIEND WHERE PHONE = '010-9999-8888';

SELECT * FROM FRIEND;
COMMIT;

SELECT * FROM FRIEND WHERE NAME LIKE '%'||'동'||'%';
SELECT * FROM FRIEND WHERE PHONE LIKE '%'||'8888'||'%';
SELECT * FROM FRIEND WHERE NAME LIKE '%'||'마'||'%' AND PHONE LIKE '%'||'8888'||'%';
