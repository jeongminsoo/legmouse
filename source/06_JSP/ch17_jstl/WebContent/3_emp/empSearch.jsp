...
<body>
	<div>
		<form action="empSch" method="post">
				이름 <input type="text" name="ename" class="search">
				직책 <input type="text" name="job" class="search">
		...
		<c:if test="${emps.size() != 0 }">
			<c:forEach items="${emps }" var="emp">
				<tr>
					...
					<td>
						<fmt:formatDate value="${emp.hiredate }" pattern="yyy년MM월dd일(E) hh:mm:ss(a)"/> 
					</td>
					<td>${emp.sal }</td>
					<td>
